...
final class FeedViewControllerTests: XCTestCase {
    ...
    func test_feedImageView_cancelsImageLoadingWhenNotVisibleAnymore() {
        ...
        XCTAssertEqual(loader.cancelledImageURLs, [image0.imageURL, image1.imageURL], "Expected two cancelled image URL request once 2nd image is not visible anymore")
    }
    ...
    private func assertThat(_ sut: FeedViewController, hasViewConfiguredFor image: FeedItem, at index: Int, file: StaticString = #file, line: UInt = #line) {
    ...
    private func assertThat(_ sut: FeedViewController, isRendering feed: [FeedItem], file: StaticString = #file, line: UInt = #line) {
        guard sut.numberofRendedFeedImageViews() == feed.count else {
            return XCTFail("Expected \(feed.count) images, got \(sut.numberofRendedFeedImageViews()) instead", file: file, line: line)
        }
    ...
    private func makeImage(description: String? = nil, location: String? = nil, url: URL = URL(string: "http://any-url.com")!) -> FeedItem {
...
extension FeedViewController {
    ...
    func numberofRendedFeedImageViews() -> Int {

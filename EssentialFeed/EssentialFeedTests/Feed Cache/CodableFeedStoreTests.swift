...
typealias FailableFeedStore = FailableDeleteFeedStoreSpecs & FailableInsertFeedStoreSpecs & FailiableRetrieveFeedStoreSpecs
...
class CodableFeedStoreTests: XCTestCase, FailableFeedStore {
    ...
    func test_storeSideEffects_runSerially() {
        ...
        XCTAssertEqual(completedOperationsInOrder, [op1, op2, op3], "Expected Side effects to run serially but operations finished in unexpected order")
    ...
    @discardableResult
    private func insert(_ cache: (feed: [FeedImage], timestamp: Date), to sut: FeedStore) -> Error? {
